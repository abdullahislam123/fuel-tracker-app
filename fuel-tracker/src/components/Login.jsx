  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white overflow-x-hidden">
      ...
      <div className="md:w-1/2 bg-linear-to-br from-emerald-500 to-slate-900 relative overflow-hidden flex items-center justify-center p-8 md:p-16 order-1 md:order-2 min-h-[35vh] md:min-h-screen">
        ...
        <div className="relative z-10 text-white max-w-md text-center md:text-left animate-slide-up">
      ...
      <div className="md:w-1/2 flex items-center justify-center p-6 sm:p-12 md:p-16 order-2 md:order-1 animate-fade-in">
        <div className="w-full max-w-sm mx-auto">
          ...
          <p className="text-slate-500 mb-8 text-sm font-medium">Login to manage your fuel expenses efficiently</p>
            ...
            <div>
                ...
                <div className="relative group">
                    ...
                    <input 
                        ...
                        className="w-full p-4 pl-12 bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white rounded-xl outline-none transition-all font-bold text-slate-700 shadow-sm"
            ...
            <div>
                ...
                <div className="relative group">
                    ...
                    <input 
                        ...
                        placeholder="••••••••" 
                        className="w-full p-4 pl-12 pr-12 bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white rounded-xl outline-none transition-all font-bold text-slate-700 shadow-sm"
