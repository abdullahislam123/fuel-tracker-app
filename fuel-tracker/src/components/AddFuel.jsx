...
const AddFuel = () => {
  ...
  // Validation state: Kaunsi field touch ho chuki hai
  ...
  // Field touch hone par ye trigger hoga
      ...
      <div className="bg-white dark:bg-neutral-900 p-6 md:p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-50 dark:border-neutral-800">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative">
            ...
            <input type="date" name="date" value={formData.date} onChange={handleInputChange} onBlur={() => handleBlur('date')}
          ...
          <div className="relative">
            ...
            <input type="time" name="time" value={formData.time} onChange={handleInputChange} onBlur={() => handleBlur('time')}
          ...
          <div className="relative">
            ...
            <input type="number" name="liters" placeholder="0.00" value={formData.liters} onChange={handleInputChange} onBlur={() => handleBlur('liters')}
          ...
          <div className="relative">
            ...
            <input type="number" name="pricePerLiter" placeholder="e.g. 264.74" value={formData.pricePerLiter} onChange={handleInputChange} onBlur={() => handleBlur('pricePerLiter')}
              className={getInputClass('pricePerLiter')} />
          ...
          <div className="relative">
            ...
            <input type="number" name="odometer" placeholder="e.g. 12450" value={formData.odometer} onChange={handleInputChange}
          ...
          <div className="relative">
            ...
            <input type="number" name="cost" placeholder="0" readOnly value={formData.cost} 
              className="w-full p-4 pl-12 bg-emerald-500/5 dark:bg-emerald-500/10 border-2 border-dashed border-emerald-200 dark:border-emerald-800/50 rounded-2xl font-black text-emerald-600 dark:text-emerald-400 outline-none" />
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-10">
          <button 
            ...
            className="flex-1 py-4 text-red-500 font-bold bg-slate-100 dark:bg-neutral-800 rounded-2xl hover:bg-slate-200 dark:hover:bg-neutral-700 transition-all active:scale-[0.98]"
          >
            Cancel
          </button>
          <button 
            onClick={handleSave} 
            disabled={loading}    
            className="flex-1 py-4 text-white font-black bg-emerald-500 rounded-2xl hover:bg-emerald-600 shadow-lg shadow-emerald-500/30 disabled:bg-slate-300 dark:disabled:bg-neutral-700 transition-all flex items-center justify-center gap-2 active:scale-[0.98]"
          >
